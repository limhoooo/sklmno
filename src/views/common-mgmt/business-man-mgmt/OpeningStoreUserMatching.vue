<template>
	<div>
		<div class="wrapper">
			<book-mark path="/openingstoreuser-matching"></book-mark>
			...
			<div class="newTableStyle tableSticky" style="overflow: auto; width: 100%; max-height: 650px">
				<table
					class="w100P"
					v-if="
				...
				<table v-else class="w100P" style="white-space: nowrap">
					<thead>
						<tr>
							<th style="width: 120px; z-index: 1; position: static !important;"></th>
							<th
								class="padW10 lh40"
