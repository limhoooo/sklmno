<template>
	<div>
		<div class="tableTopOption">
			...
			<div>
				<v-btn style="background-color: white" @click="deleteProviderFnc">
					삭제
				</v-btn>
				<v-btn
					@click="regiDialogFnc"
					...
					<template v-else>
						...
						>
							...
							<td onclick="event.cancelBubble=true">
								...
								/>
								<label :for="`voteUseY${item.provId}`" style="margin: 0 5px"
									>Y</label
								>
								<input
									type="radio"
								...
								/>
								<label :for="`voteUseN${item.provId}`" style="margin: 0 5px"
									>N</label
								>
							</td>
							<td>
